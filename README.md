...
A schema package plugin for sintering.
...
```sh
git clone https://github.com/Tanmay2028/sintering.git
cd sintering
...
```sh
pip install dist/sintering-0.1.0
```
...
| Name | E-mail     |
|------|------------|
| Tanmay Kulkarni | [tanmay.kulkarni@fau.de](mailto:tanmay.kulkarni@fau.de)
